...
STOP_LOSS_PCT = float(os.getenv("STOP_LOSS_PCT", "0.50"))  # exit if position loses this fraction of entry value
HOURS_BEFORE_EXPIRY = float(os.getenv("HOURS_BEFORE_EXPIRY", "2.0"))  # exit position this many hours before market closes
